  ...
  if (!patron) {
    return (
      <div className="w-[120px] aspect-[2/3] bg-gradient-to-br from-[#5a4a22] via-[#3a2f15] to-[#5a4a22] p-[2px] rounded-lg shadow-inner">
        <div className="w-full h-full bg-[#1a0508] bg-[radial-gradient(circle_at_center,#2a0b10_0%,#0f0204_100%)] rounded-md flex flex-col items-center justify-center gap-2 p-2 relative z-10 text-[#F5E6C4]">
          ...
          {children || <span className="text-xs font-bold uppercase tracking-wider text-shadow-[1px_1px_2px_rgba(0,0,0,0.8)] text-center">Patron</span>}
        </div>
      </div>
    );
  }
